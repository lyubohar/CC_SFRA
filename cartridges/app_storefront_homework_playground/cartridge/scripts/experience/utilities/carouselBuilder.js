...
function init(model, context) {
    ...
    model.regions.slides.setComponentClassName('' + sizeExtraSmall + sizeSmall + sizeMedium);
    model.regions.slides.setComponentClassName('' + sizeExtraSmall + sizeSmall + sizeMedium, { position: 0 });
